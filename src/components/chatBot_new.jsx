...
const ChatBot = () => {
    ...
    return (
        <div className="flex flex-col justify-between w-full h-full shadow-xl rounded-t-xl">
            {/* Header */}
            <div className="flex items-center justify-between px-4 py-3 text-white bg-teal-600 rounded-t-xl">
                <h3 className="text-lg font-medium">Chat with Alex - Your Mental Health Assistant</h3>
            ...
            <div className="p-4 h-[75vh] overflow-auto bg-gray-50">
                {messages.map((msg, index) => (
                    <div key={index} className="mb-4">
                        ...
                        <div className="mt-2 font-semibold text-teal-600">Alex:</div>
                        <div className="flex items-center gap-4 p-3 bg-white rounded-lg shadow-sm">
                            <div className="flex items-center justify-center w-8 h-8 text-white bg-teal-600 rounded-full">
                                A
                            </div>
                            {msg.bot}
                        </div>
            ...
            <div className="p-4 bg-white border-t border-gray-200">
                ...
                <div className="flex items-center gap-2">
                    <textarea
                        ...
                        className="flex-1 p-2 border border-gray-300 rounded-lg resize-none focus:ring-2 focus:ring-teal-300 focus:border-teal-500"
                        rows={2}
                        onKeyDown={(e) => {
                    ...
                    <button 
                        ...
                        disabled={isLoading} 
                        className="p-3 text-white transition-colors bg-teal-600 rounded-lg hover:bg-teal-700 disabled:bg-teal-400"
                        title="Send message"
                    >
                        {isLoading ? 
